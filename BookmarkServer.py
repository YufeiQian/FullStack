...
class ThreadHTTPSever(ThreadingMixIn, http.server.HTTPServer):
...
class Shortener(http.server.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if "longuri" not in params or "shortname" not in params:
            ...
            self.end_headers()
            msg = 'Please enter both of the long uri and short uri'
...
if __name__ == '__main__':
    ...
    server_address = ('', port)
    httpd = ThreadHTTPSever(server_address, Shortener)
    httpd.serve_forever()
